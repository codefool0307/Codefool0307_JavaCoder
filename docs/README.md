 ...
 * @LastEditTime: 2020-04-26 23:01:22
...
## 学习进度
| 周次   | 时间           | 内容部分                     | 完成度      | 数据结构与算法知识点                                                                                                                                                                                                                                                                                                                                                                      |
|------|--------------|--------------------------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 第10周 | 4\.27\-5\.3  | TCP（共计15小时）              | :wrench: | 排序与链表基础<br>链表问题对于笔试和面试阶段的解题方法论<br>常见的链表面试题目<br>利用快慢指针<br>哈希表和有序表在使用层次上的简单介绍<br>详解递归函数完成二叉树的三种遍历<br>详解非递归函数完成二叉树的三种遍历<br>详解二叉树的序列化和反序列化（深度优先与宽度优先遍历）<br>折纸问题<br>判断搜索二叉树<br>判断完全二叉树<br>判断平衡二叉树<br>二叉树节点的前驱节点与后继节点<br>图结构的表示方法<br>图的深度优先遍历与宽度优先遍历<br>拓扑排序问题<br>                                                                                                                    |
| 第11周 | 5\.4\-5\.10  | 数据库（共计55小时）              | :wrench: | 最小生成树问题<br>单源最短路径问题<br>详解前缀树<br>介绍贪心算法及其相关题目<br>在面试中如何快速的尝试出贪心策略<br>常见的递归问题<br>几种常见的尝试类型<br>哈希函数与哈希表<br>位图与布隆过滤器详解<br>一致性哈希结构<br>详解有序表（红黑树、跳表、sb树、avl树<br>详解并查集结构的应用（岛问题）<br>KMP算法<br>Manacher算法<br>滑动窗口的最大值与最小值更新结构<br>单调栈结构<br>二叉树的morris遍历<br>树形dp解题套路<br>大数据题目与空间限制题目常见解法<br>位运算常见题目<br>                                                                                    |
| 第12周 | 5\.11\-5\.17 | 数据库（共计55小时）              | :wrench: | 从暴力递归到动态规划（上）<br>从暴力递归到动态规划（下）与社会嗑<br>定长的绳子覆盖数轴上最多多少点<br>捆绑交易恰好购买苹果问题<br>4^x次幂吃草问题<br>正方形01染色<br>01矩阵输出边框全是1的最大正方形的边长长度<br>已知区间等概函数，设计新区间等概函数<br>限制最大值的子数组<br>可以转换的不同字符串的个数<br>括号序列问题<br>树的路径最大权值和问题<br>                                                                                                                                                                        |
| 第13周 | 5\.18\-5\.24 | 框架复习（7天）                 | :wrench: | 给定二叉树节点数求二叉树结构方案<br>机器人抓物品<br>矩阵旋转90°<br>有序二维数组找数是否在该数组中<br>数组中找划分的最大值<br>容器能装多少水<br>地形能装多少水<br>牛牛新标准算报酬<br>判断字符串是否为旋转词<br>牛牛的春游<br>二维数组最小路径和<br>最长公共子序列<br>最长公共子串<br>斐波那契数列问题O\(logN\)的解法及其扩展<br>所有长度为N的字符串中达标字符串的数量<br>出现次数最多的前K个字符串<br>TopKRecord结构<br>                                                                                                                      |
| 第14周 | 5\.25\-5\.31 | 框架（46小时）                 | :wrench: | 输出路径中蕴含的目录结构<br>二叉树转化为有序双向链表<br>找到一棵二叉树中的最大搜索二叉子树<br>给定中序和先序输出后序遍历<br>安置路灯所需最少路灯数<br>子数组最大累加和<br>整型矩阵子矩阵最大累加和<br>字符串互换最小代价<br>最长递增子序列问题<br>求完全二叉树节点的个数<br>最大子数组异或和<br>字符串的组合方式<br>字符串中没有重复字符子串中最长的长度<br>删除字符串中字符使得每种字符只保留一个，并让字典序最小<br>字符串最短的变换路径<br>未排序数组求排序后相邻两数最大差值ON<br>不重叠的非空区间数字的异或和等于0的数量<br>两个有序数组找k大<br>公司招聘 约瑟夫环<br>                                                  |
| 第15周 | 6\.1\-6\.7   | 框架（46小时）                 | :wrench: | 给定大楼返回轮廓线数组<br>正值数组求所有的子数组中累加和等于k的最长子数组长度<br>无限制数组所有的子数组中累加和等于k的最长子数组长度<br>无限制数组所有的子数组中累加和小于等于k的最长子数组长度<br>拿铜板游戏 博弈论<br>树上的最大路径和<br>蛇形数组<br>公式计算<br>咖啡机冲咖啡<br>乘客过河<br>最长的回文子序列<br>加字符使得串变成回文<br>字符串回文子串的最小分割数<br>删成回文串的方案数<br>最小的第k个数<br>一个数拆分方案数<br>有k个逆序对的排列数 dp<br>给定二叉树头结点，返回最大的且符合搜索二叉树条件的最大拓扑结构的大小<br>把数组\{L1,L2,\.\.,Ln,R1,R2,\.\.,Rn\}调整为\{R1,L1,R2,L2,\.\.,Rn,Ln\}<br> |
| 第16周 | 6\.8\-6\.14  | 项目一（38小时）                | :wrench: | 项目分配问题<br>二叉树寻找错误结点<br>山峰相见问题<br>矩形重叠 二维前缀和<br>通配符字符串匹配<br>leetcode freedom\-trail<br>打气球得最大分数<br>汉诺塔问题<br>合并数字最小代价<br>含有给定字符串的最小子串长度<br>实现缓存结构<br>加油站良好出发点问题<br>                                                                                                                                                                                                               |
